...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
    public void Configure(EntityTypeBuilder<Order> builder)
    {
        ...
        builder.ComplexProperty(c => c.ShippingAddress, addressBuilder =>
        {
            ...
            addressBuilder.Property(a => a.LastName).HasMaxLength(180).IsRequired();
        ...
        builder.ComplexProperty(a => a.Payment, paymentBuilder =>
        {
            paymentBuilder.Property(p => p.CardNumber).HasMaxLength(50);
        ...
        builder.Property(c => c.Status).HasDefaultValue(OrderStatus.Draft)
            .HasConversion(
            s => s.ToString(),
